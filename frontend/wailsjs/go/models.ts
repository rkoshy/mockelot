export namespace main {
	...
	export class ContainerTestResult {
	    success: boolean;
	    message: string;
	    logs?: string;
	
	    static createFrom(source: any = {}) {
	        return new ContainerTestResult(source);
	    }
...
export namespace models {
	...
	export class DNSOverrideConfig {
	    enabled: boolean;
	    ...
	    static createFrom(source: any = {}) {
	        return new DNSOverrideConfig(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.enabled = source["enabled"];
	        this.overrides = this.convertValues(source["overrides"], DNSOverride);
	        this.upstream_servers = source["upstream_servers"];
	        this.use_system_dns = source["use_system_dns"];
	    }
	...
	export class SOCKS5DomainInfo {
	    ...
	    static createFrom(source: any = {}) {
	        return new SOCKS5DomainInfo(source);
	    }
